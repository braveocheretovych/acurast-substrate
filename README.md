...
Acurast Substrate is a [Cumulus](https://github.com/paritytech/cumulus/)-based parachain. The [Cumulus Parachain Tempalte](https://github.com/paritytech/cumulus) was used as the base for the node and runtime implementation.
